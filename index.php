...
global $wgMainDirectory, $wgMobileServer;
...
<meta property="og:image" content="http://clevertrail.com/images/defaultlogo.jpg" /> 
...
<div id="divGlobalWrapper">
	...
	drawToolBar($userName, $links, "", getNumberOfFinishedTrails($userName)); 
	
	//draw the side bar (navigation)
	//drawSideColumn($wgPathOfWiki, '', 0);
	
	//draw common divs
	drawCommonDivs();
	?>
	<div style="position: absolute; top: 80px; width:100%; left:0px;">
		<?php
...
<noscript> 
	<div id="divNoJavascriptWarning" style="position:absolute; width: 100%; height:100%; z-index:9999; background: #fff; color: #000;">
		<br><br>
		m.CleverTrail.com is designed for browsers with javascript enabled.<br><br>
		Please consider turning your javascript on and then trying CleverTrail again.<br><br>
		Thanks!<br><br>

		<a href="<?php echo $wgMobileServer;?>">m.CleverTrail.com</a>
